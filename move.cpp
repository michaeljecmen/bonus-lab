...
// make move
// use make move-elide to see how the compiler would automatically optimize this
...
class MyIntVector {
   ...
   public:
    ...
    MyIntVector(MyIntVector&& other) : MyIntVector() {
...
MyIntVector create_big_vector(int n) {
    ...
    return big_vec;  // RVO! make move-elide to show
}
...
int main() {
    ...
    // now remove default ctor from move ctor and try again
}
